        ...
        <div class="space-y-1">
            ...
            >
                ...
                >
                    <template #body="{ data }">
                        <div class="flex items-center gap-3">
                            <div
                                class="w-10 h-10 rounded-xl bg-slate-50 text-slate-500 flex items-center justify-center shadow-sm"
                            >
                ...
                <Column
                    ...
                    :header="$t('finance.account_number')"
                >
                    <template #body="{ data }">
                ...
                >
                    <template #body="{ data }">
                        ...
                        >
                            <span class="text-xs font-bold mr-1 text-slate-400"
                                >Rp</span
                            >
                            {{ money(data.balance) }}
                        </span>
            ...
            <Dialog
                ...
                :style="{ width: '450px' }"
                :header="form.id ? 'Edit Rekening' : 'Tambah Rekening Baru'"
                :modal="true"
            ...
            >
                <div class="space-y-6">
                    <div
                        class="flex items-start gap-4 p-4 bg-emerald-50 rounded-2xl border border-emerald-100"
                    >
                        <div
                            class="w-10 h-10 rounded-xl bg-emerald-500 text-white flex items-center justify-center shrink-0"
                        >
                        ...
                        <div>
                            ...
                            <p
                                class="text-[11px] text-emerald-700/70 leading-relaxed font-medium"
                            >
                                Rekening ini akan digunakan sebagai sumber dana
                                atau penampung pendapatan dalam transaksi
                                keuangan.
                            </p>
                        </div>
                    </div>
...
async function save() {
    if (!form.name) {
        toast.add({
            severity: "error",
            summary: "Error",
            detail: "Nama rekening wajib diisi.",
            life: 3000,
        });
        return;
    }
