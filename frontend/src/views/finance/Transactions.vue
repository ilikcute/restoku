    ...
    <AppPage title="Keuangan" :breadcrumb="['Manajemen', 'Transaksi']" no-card>
        ...
        <div class="space-y-1">
            ...
            >
                ...
                <Column :header="$t('common.category')">
                    <template #body="{ data }">
                        <div class="flex items-center gap-2">
                            <div
                                class="w-8 h-8 rounded-lg flex items-center justify-center bg-slate-50 text-slate-500"
                            >
                                <i
                                    :class="[
                                        'pi',
                ...
                >
                    <template #body="{ data }">
                        ...
                        >
                            <span class="text-xs font-bold mr-0.5">{{
                                data.type === "income" ? "+" : "-"
                            }}</span>
            ...
            <Dialog
                ...
                :style="{ width: '500px' }"
                :header="form.id ? 'Edit Transaksi' : 'Transaksi Baru'"
                :modal="true"
            ...
            >
                <div class="space-y-6">
                    <!-- Form Header Info -->
                    <div
                        class="flex items-start gap-4 p-4 rounded-2xl border transition-colors duration-300"
                        :class="
                            form.type === 'income'
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p
                                ...
                                "
                            >
                                Pencatatan keuangan yang akurat membantu Anda
                                menganalisa performa bisnis dengan lebih baik.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <DatePicker
                                    ...
                                    pt:input:class="!bg-slate-50 !border-slate-100 !p-3 !text-sm"
                                />
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <Textarea
                                ...
                                class="!rounded-xl !bg-slate-50 !border-slate-100 focus:!ring-blue-500 !p-3 !text-sm"
                                autoResize
                            />
                        </div>
                    </div>
                ...
                <template #footer>
                    <div class="flex gap-3 p-2">
                        ...
                        <Button
                            ...
                            :loading="saving"
                            :class="[
                                '!rounded-xl !border-none !px-8 h-12 font-bold shadow-lg',
                                form.type === 'income'
...
async function save() {
    if (!form.account_id || !form.amount || !form.description) {
        toast.add({
            severity: "error",
            summary: "Error",
            detail: "Mohon lengkapi semua field wajib.",
            life: 3000,
        });
        return;
    }
    ...
    try {
        ...
        form.transaction_date = new Date(d.getTime() - offset * 60 * 1000)
            .toISOString()
            .split("T")[0];
        ...
        toast.add({
            ...
            detail: "Transaksi berhasil disimpan",
            life: 2000,
        });
        loadRows();
    } catch (error) {
