<template>
    ...
    >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
                <div
                    class="w-20 h-20 bg-emerald-50 rounded-2xl flex items-center justify-center"
                >
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">
                        Unduh seluruh data master Anda (Produk, Kategori,
                        Supplier, dll) dalam format JSON untuk cadangan.
                    </p>
                </div>
                <Button
            ...
            >
                <div
                    class="w-20 h-20 bg-amber-50 rounded-2xl flex items-center justify-center"
                >
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">
                        ...
                        <span class="text-rose-500 font-bold">Peringatan:</span>
                        Proses ini akan memperbarui data yang ada.
                    </p>
                </div>
                <input
                    type="file"
        ...
        <!-- Info Section -->
        <div
            class="mt-8 bg-sky-50 p-6 rounded-2xl border border-sky-100 flex gap-4 items-start"
        >
            ...
            <div class="space-y-1">
                ...
                <p class="text-sky-700 text-sm leading-relaxed">
                    Sistem ini melakukan backup pada data master saja. Data
                    transaksi (penjualan) tidak termasuk dalam file ini untuk
                    menjaga ukuran file tetap ringan. Pastikan Anda melakukan
                    backup secara rutin setelah melakukan banyak perubahan pada
                    data produk atau harga.
                </p>
            </div>
        </div>
    </AppPage>
...
async function exportDatabase() {
    ...
    try {
        ...
        toast.add({
            ...
            detail: "File backup berhasil diunduh",
            life: 3000,
        });
    } catch (error) {
...
function handleImport(event) {
    ...
    confirm.require({
        message:
            "Apakah Anda yakin ingin memulihkan data dari backup ini? Data yang ada akan diperbarui/ditambahkan.",
        ...
        accept: async () => {
            ...
            try {
                ...
                toast.add({
                    ...
                    detail: "Data Anda telah diperbarui",
                    life: 3000,
                });
                // Clear input
                event.target.value = "";
