<template>
    <AppPage
        ...
        :breadcrumb="[$t('common.settings'), $t('sidebar.profile')]"
    >
            ...
            <Card class="!rounded-3xl border-none shadow-sm overflow-hidden">
                ...
                <template #content>
                    <div class="p-2 space-y-1">
                        ...
                        <div class="pt-2">
                            <Button
                                :label="$t('settings.update_profile')"
                                icon="pi pi-check"
                    ...
                    <div class="p-2 space-y-5">
                        <div class="flex flex-col gap-2">
                            ...
                            <Password
                                ...
                                :feedback="false"
                                class="w-full"
                                inputClass="w-full !rounded-xl !bg-slate-50 !border-slate-100"
                                placeholder="••••••••"
                                toggleMask
                            />
                        </div>
...
async function savePassword() {
    ...
    try {
        ...
        toast.add({
            severity: "success",
            summary: $t("settings.change_password"),
            life: 2000,
        });
    } catch (error) {
        toast.add({
