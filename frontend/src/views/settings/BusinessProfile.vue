                    ...
                    <div class="p-2 space-y-1">
                        ...
                        <div class="flex flex-col items-center gap-4 py-2">
                            <label
                                ...
                                >{{ $t("settings.business_logo") }}</label
                            >
                            <div class="relative group">
                                ...
                                >
                                    <i
                                        class="pi pi-image text-slate-300 text-4xl"
                                    ></i>
                                </div>
                                <img
                                    v-else
                                ...
                                >
                                    <i
                                        class="pi pi-camera text-white text-2xl"
                                    ></i>
                                    <input
                                        type="file"
                        ...
                        <div class="pt-2 border-t border-slate-50">
                            <Button
                                :label="$t('common.save')"
                                icon="pi pi-check"
                                class="!rounded-xl !px-8 h-12 font-bold shadow-lg shadow-emerald-100"
                                :loading="saving"
                                @click="save"
                            />
                        </div>
                    ...
                    <div class="p-2 space-y-5">
                        <div class="flex flex-col gap-2">
                            ...
                            <Textarea
                                ...
                                :placeholder="
                                    $t('settings.receipt_footer_desc')
                                "
                            />
                        ...
                        <div
                            class="bg-slate-50 rounded-2xl p-6 border border-dashed border-slate-200"
                        >
                            <div
                                class="max-w-[250px] mx-auto bg-white shadow-sm p-4 text-[10px] font-mono text-slate-600 space-y-2"
                            >
                                <div
                                    class="text-center border-b border-dashed border-slate-200 pb-2 mb-2"
                                >
                                    ...
                                    <p
                                        class="font-bold text-xs text-slate-900 uppercase"
                                    >
                                        {{ form.name || "NAMA OUTLET" }}
                                    </p>
                                    <p>
                                        {{ form.address || "Alamat Outlet..." }}
                                    </p>
                                    <p>Telp: {{ form.phone || "-" }}</p>
                                </div>
                                ...
                                <div
                                    class="text-center pt-4 border-t border-dashed border-slate-200 mt-2 italic whitespace-pre-line"
                                >
                                    {{
                                        form.footer_text ||
...
async function load() {
    try {
        ...
        toast.add({
            severity: "error",
            summary: "Error",
            detail: "Gagal memuat data profil bisnis",
            life: 3000,
        });
    }
}
...
async function save() {
    ...
    try {
        ...
        toast.add({
            ...
            detail: $t("settings.business_profile"),
            life: 2000,
        });
