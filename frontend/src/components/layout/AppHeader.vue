<template>
  <header class="flex min-h-[4rem] py-3 shrink-0 items-center justify-between px-4 md:px-6 bg-white rounded-2xl shadow-sm border border-slate-100 transition-all duration-300">
    ...
    <div class="flex items-center gap-2">
      ...
      <!-- Settings Icon -->
      <button
        class="p-2.5 rounded-xl hover:bg-slate-100 text-slate-500 transition-colors"
      ...
      <!-- User Profile -->
      <button
        class="flex items-center gap-2.5 hover:bg-slate-50 p-1.5 pr-3 rounded-2xl transition-colors"
